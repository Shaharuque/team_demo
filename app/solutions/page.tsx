...
import RightCard from './_component/Solutions/RightCard';
import SelectSolution from './_component/Solutions/SelectSolution';


const solutionsPage = () => {
    return (
        <div className="svg-container overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" width="400" viewBox="0 0 717 411" fill="none">
            ...
            <div>
                <div className="grid grid-cols-1 lg:grid-cols-2  mx-[80px] my-[40px]">
                    <div className="z-10">
                        <RightCard></RightCard>
                    </div>
                    <div className=" z-10">
