...
//   const events = [
//     { title: 'Event 1', resourceId: 'resource1', start: '2024-01-18T10:00:00', end: '2024-01-18T12:00:00' },
//     { title: 'Event 2', resourceId: 'resource2', start: '2024-01-18T14:00:00', end: '2024-01-18T16:00:00' },
  ...
  const events = [
    {
      ...
      resourceId: 'room1', // Associate event with a resource
    },
    {
      title: 'Event 2',
    ...
    },
    {
      title: 'Event 3',
      start: moment().add(2, 'days').toDate(),
      end: moment().add(2, 'days').add(6, 'hours').toDate(),
      resourceId: 'room1',
    },
    {
      title: 'Event 4',
